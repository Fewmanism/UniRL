...
Default code agent guidance lives here for all code agents, including Claude Code (>= 2.1.277 reads `AGENTS.md` natively). Agents that need an explicit import, including Cursor, should reference this file with `@AGENTS.md` and add only agent-specific differences.
